...
public class CircleController {
    ...
    public ResponseEntity<ApiResponse<CircleResponse>> getCircles(@PathVariable String id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(ApiResponseCode.CANVAS_LOADED, circle));
    }
    ...
    public ResponseEntity<ApiResponse<List<CircleResponse>>> getCircles() {
        ...
        return ResponseEntity.ok(ApiResponse.success(ApiResponseCode.CANVAS_LOADED, circles));
    }
    ...
    public ResponseEntity<ApiResponse<String>> deleteCircle(@PathVariable String id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(ApiResponseCode.CIRCLE_DELETED));
    }
